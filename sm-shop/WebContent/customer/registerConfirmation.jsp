...
<div id="registerform" style="left: 60px" class="formcontent">
    ...
    <fieldset>
		<legend><s:text name="customer.registration"/></legend>
		...
		<div class="formelement">
	      ...
	      <div class="formelement">
            ...
            <div class="formelement">
                  <label class="formlabel" for="email">
                  <span class="required"><s:text name="label.required"/></span><s:text name="label.emailaddressrepeat"/>:<br /><span class="formerror"><%=MessageUtil.displayFormErrorMessageNoFormating(request,"customerEmailAddressRepeat")%></span>
		...
		<div class="formelement">
			<label class="formlabel" for="submit">
				<img src="../components/captchaImage.jsp">customerEmailAddressRepeat<span class="formerror"><%=MessageUtil.displayFormErrorMessageNoFormating(request,"captcha_response")%></span>
			</label>
			<s:textfield name="captcha_response" id="captcha_response" cssStyle="text-transform: uppercase;" value="" size="10"/> 
		</div>

		<div class="formelement">
			<label class="formlabel" for="submit">
				&nbsp;<br /><span class="formerror"><%=MessageUtil.displayFormErrorMessageNoFormating(request,"")%></span>
			</label>
		...
		<div class="formelement" id="submit">
			<label class="formlabel" for="submit">&nbsp;
									...
									<a href="javascript:validate();" class="submit">
										<div class="href-button">
											<span class="button1-box1"></span>
											<span class="button1-box2a"><s:text name="customer.register" /></span>
